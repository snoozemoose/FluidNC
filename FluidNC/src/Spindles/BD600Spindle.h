...
namespace Spindles {
    ...
    protected:
        uint16_t _minFrequency = 100;    // PD011: frequency lower limit. Normally 0.
        uint16_t _maxFrequency = 400;  // PD005: max frequency the VFD will allow. Normally 400.
        uint16_t _maxRpmAt50Hz = 1500;  // PD144: rated motor revolution at 50Hz => 24000@400Hz = 3000@50HZ
        uint16_t _numberPoles  = 4;    // PD143: 4 or 2 poles in motor. Default is 4. A spindle being 24000RPM@400Hz implies 2 poles
